...
SWEP.viewmodel				= "models/weapons/v_pist0l.mdl"
...
function SWEP:PrimaryAttack()
	...
	angles.x = angles.x + random.RandomInt( -0.1, 0.1 );
	angles.y = angles.y + random.RandomInt( -0.1, 0.1 );
	angles.z = 0;
...
if not _CLIENT then
	...
	pPlayer:ViewPunch( QAngle( -0.2, random.RandomFloat( -0.02, 0.02 ), 0 ) );
